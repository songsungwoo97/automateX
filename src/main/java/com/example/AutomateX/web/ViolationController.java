...
public class ViolationController {
    ...
    public List<AnnualViolationCountDto> getAnnualViolation(@RequestParam("port") String port) {
    ...
    public List<Integer> getMonthlyViolation(@RequestParam("pier") String pier) {
    ...
    public List<String> getNewViolation(@RequestParam("pier") String pier) {
